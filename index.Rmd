...
The application itself may be viewed [here](https://ericsueckert.shinyapps.io/college_admissions_visualization/). It may take a minute or two to load in order to activate the application if no one has visited it recently.

The repository may be viewed [here](https://github.com/ericsueckert/Final-Project-X).

Although the project was turned in earlier this year, I may have plans to continue working on it.
